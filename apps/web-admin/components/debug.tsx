...
export const debugFunction = () => {
  ...
  export const DebugButton = ({debugFunction }: {debugFunction: () => void}) => {
    ...
    return (
      <Button
        variant="outline"
        className="absolute bottom-8 hover:scale-110 left-4 shadow-lg shadow-teal-500 hover:shadow-pink-400 rounded-xl bg-pink-400/80 backdrop-blur-xl hover:bg-teal-500/80 transition-all duration-500 z-[99999]"
